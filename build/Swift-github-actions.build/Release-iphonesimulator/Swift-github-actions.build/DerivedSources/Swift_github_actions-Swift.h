...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Swift_github_actions",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20Swift_github_actions11AppDelegate")
...
SWIFT_CLASS("_TtC20Swift_github_actions13SceneDelegate")
...
SWIFT_CLASS("_TtC20Swift_github_actions14ViewController")
